...
class AnalystAgent(BaseAgent):
    ...
    async def _classify_threat(self, content: str) -> List[str]:
        ...
        try:
            ...
            self.logger.warning(f"Threat classification failed: {exc}")
            return []
    ...
    async def _identify_patterns(self, content: str) -> List[Dict]:
        ...
        try:
            ...
            self.logger.warning(f"Pattern identification failed: {exc}")
            return []
    ...
    async def _extract_chain(self, content: str) -> List[Dict]:
        ...
        try:
            ...
            self.logger.warning(f"Chain extraction failed: {exc}")
            return []
    ...
    async def _generate_analysis_summary(
        ...
        try:
            ...
            return f"检测到{categories_str}类威胁，置信度{confidence_score:.0%}。"
